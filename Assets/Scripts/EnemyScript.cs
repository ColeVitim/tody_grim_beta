...
public class EnemyScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (CanSeePlayer(agroRangeMin) && !CanSeePlayer(agroRangeAttack) && !isCharging && !isCasting && !isHiding && detected)
        {
            ChasePlayer();

        }
        else if(CanSeePlayer(agroRangeAttack) && !isCharging && !isCasting && !isHiding && detected)
        { 
            Attack();
        }
        
        else if(isFlee && !isAboutCast && !isCasting && !isHiding)
        {
            FleePlayer();
        }
        else if(isAboutCast && !isHiding)    
        {
            ChasePlayer();
        }
